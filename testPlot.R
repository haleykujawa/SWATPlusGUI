...
# if ('hist' %in% SelectClimate){
 ...
 ##### new hru plots comparing hru loss from all agricultural hrus and hrus with change implemented only ##### 
  ...
  #### Climate scenario ######
  # keep this separate from the above code bc HRU comparisons are different
  # Land use change only looks at only HRUs that were altered, climate change looks at both land use and climate so looks at all HRUs
